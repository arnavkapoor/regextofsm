...
\020 = 4     0 = 2     P = 2     p = 2  \220 = 2  \260 = 2  \320 = 2  \360 = 2  
...
flex version 2.6.0 usage statistics:
  ...
  26/2000 NFA states
  21/1000 DFA states (25 words)
  1 rules
  Compressed tables always back-up
  Beginning-of-line patterns used
  1/40 start conditions
  8 epsilon states, 3 double epsilon states
  3/100 character classes needed 1/500 words of storage, 0 reused
  62 state/nextstate pairs created
  19/43 unique/duplicate transitions
  39/1000 base-def entries created
  71/2000 (peak 85) nxt-chk entries created
  90/2500 (peak 90) template nxt-chk entries created
  6 empty table entries
  18 protos created
  18 templates created, 18 uses
  5/256 equivalence classes created
  5/256 meta-equivalence classes created
  0 (0 saved) hash collisions, 1 DFAs equal
  0 sets of reallocations needed
  481 total table entries needed
