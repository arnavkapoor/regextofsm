...
********** beginning dump of nfa with start state 24
state #    1	257:     0,    0
state #    2	257:     0,    0
state #    3	100:     4,    0
state #    4	 -1:     5,    0
...
\004 = 1     $ = 1     D = 1     d = 5  \204 = 1  \244 = 1  \304 = 1  \344 = 1  
...
\020 = 1     0 = 1     P = 4     p = 7  \220 = 1  \260 = 1  \320 = 1  \360 = 1  
...
\027 = 1     7 = 3     W = 1     w = 1  \227 = 1  \267 = 1  \327 = 1  \367 = 1  
...
flex version 2.6.0 usage statistics:
  ...
  83 state/nextstate pairs created
  18/65 unique/duplicate transitions
  31/1000 base-def entries created
  26/2000 (peak 83) nxt-chk entries created
  24/2500 (peak 84) template nxt-chk entries created
  0 empty table entries
  12 protos created
  12 templates created, 13 uses
  7/256 equivalence classes created
  2/256 meta-equivalence classes created
  0 (0 saved) hash collisions, 2 DFAs equal
  0 sets of reallocations needed
  377 total table entries needed
