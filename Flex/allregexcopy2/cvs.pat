...
********** beginning dump of nfa with start state 12
state #    1	257:     0,    0
state #    2	257:     0,    0
state #    3	 66:     4,    0
state #    4	 69:     5,    0
...
\016 = 1     . = 1     N = 6     n = 1  \216 = 1  \256 = 1  \316 = 1  \356 = 1  
...
flex version 2.6.0 usage statistics:
  ...
  18/2000 (peak 30) nxt-chk entries created
  30/2500 (peak 36) template nxt-chk entries created
  0 empty table entries
  5 protos created
  6 templates created, 6 uses
  6/256 equivalence classes created
  5/256 meta-equivalence classes created
  0 (0 saved) hash collisions, 1 DFAs equal
  0 sets of reallocations needed
  328 total table entries needed
