%%
1	^\377[\373-\376].\377[\373-\376].\377[\373-\376]
2	End Marker


********** beginning dump of nfa with start state 15
state #    1	257:     0,    0
state #    2	257:     0,    0
state #    3	255:     4,    0
state #    4	 -1:     5,    0
...
\033 = 1     ; = 1     [ = 1     { = 1  \233 = 1  \273 = 1  \333 = 1  \373 = 3  
\034 = 1     < = 1     \ = 1     | = 1  \234 = 1  \274 = 1  \334 = 1  \374 = 3  
\035 = 1     = = 1     ] = 1     } = 1  \235 = 1  \275 = 1  \335 = 1  \375 = 3  
\036 = 1     > = 1     ^ = 1     ~ = 1  \236 = 1  \276 = 1  \336 = 1  \376 = 3  
\037 = 1     ? = 1     _ = 1  \177 = 1  \237 = 1  \277 = 1  \337 = 1  \377 = 4  
...
flex version 2.6.0 usage statistics:
  ...
  16/2000 NFA states
  12/1000 DFA states (15 words)
  1 rules
  Compressed tables always back-up
  Beginning-of-line patterns used
  1/40 start conditions
  7 epsilon states, 3 double epsilon states
  6/100 character classes needed 13/500 words of storage, 0 reused
  19 state/nextstate pairs created
  10/9 unique/duplicate transitions
  21/1000 base-def entries created
  22/2000 (peak 32) nxt-chk entries created
  36/2500 (peak 36) template nxt-chk entries created
  0 empty table entries
  9 protos created
  9 templates created, 9 uses
  4/256 equivalence classes created
  4/256 meta-equivalence classes created
  0 (0 saved) hash collisions, 1 DFAs equal
  0 sets of reallocations needed
  346 total table entries needed
