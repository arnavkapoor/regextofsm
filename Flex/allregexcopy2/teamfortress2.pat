...
\006 = 1     & = 1     F = 1     f = 6  \206 = 1  \246 = 1  \306 = 1  \346 = 1  
  ...
  \r = 1     - = 1     M = 1     m = 7  \215 = 1  \255 = 1  \315 = 1  \355 = 1  
...
\024 = 1     4 = 1     T = 3     t = 8  \224 = 1  \264 = 1  \324 = 1  \364 = 1  
...
flex version 2.6.0 usage statistics:
  ...
  117 state/nextstate pairs created
  31/86 unique/duplicate transitions
  26/1000 base-def entries created
  37/2000 (peak 79) nxt-chk entries created
  14/2500 (peak 63) template nxt-chk entries created
  2 empty table entries
  11 protos created
  7 templates created, 14 uses
  9/256 equivalence classes created
  2/256 meta-equivalence classes created
  0 (0 saved) hash collisions, 15 DFAs equal
  0 sets of reallocations needed
  391 total table entries needed
