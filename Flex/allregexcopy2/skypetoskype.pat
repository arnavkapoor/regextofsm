...
flex version 2.6.0 usage statistics:
  ...
  35 state/nextstate pairs created
  18/17 unique/duplicate transitions
  38/1000 base-def entries created
  41/2000 (peak 51) nxt-chk entries created
  54/2500 (peak 54) template nxt-chk entries created
  0 empty table entries
  17 protos created
  18 templates created, 17 uses
  3/256 equivalence classes created
  3/256 meta-equivalence classes created
  0 (0 saved) hash collisions, 1 DFAs equal
  0 sets of reallocations needed
  417 total table entries needed
