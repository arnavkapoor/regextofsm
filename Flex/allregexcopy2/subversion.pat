...
********** beginning dump of nfa with start state 8
state #    1	257:     0,    0
state #    2	257:     0,    0
state #    3	 40:     4,    0
state #    4	257:     0,    0  [1]
...
\006 = 1     & = 1     F = 1     f = 1  \206 = 1  \246 = 1  \306 = 1  \346 = 1  
  ...
  \b = 1     ( = 2     H = 1     h = 1  \210 = 1  \250 = 1  \310 = 1  \350 = 1  
...
flex version 2.6.0 usage statistics:
  ...
  4 state/nextstate pairs created
  3/1 unique/duplicate transitions
  7/1000 base-def entries created
  6/2000 (peak 2) nxt-chk entries created
  2/2500 (peak 4) template nxt-chk entries created
  0 empty table entries
  2 protos created
  2 templates created, 2 uses
  2/256 equivalence classes created
  1/256 meta-equivalence classes created
  0 (0 saved) hash collisions, 1 DFAs equal
  0 sets of reallocations needed
  284 total table entries needed
