...
\004 = 1     $ = 1     D = 3     d = 5  \204 = 1  \244 = 1  \304 = 1  \344 = 1  
...
\031 = 1     9 = 1     Y = 1     y = 7  \231 = 1  \271 = 1  \331 = 1  \371 = 1  
...
\037 = 1     ? = 1     _ = 1  \177 = 1  \237 = 1  \277 = 1  \337 = 1  \377 = 8  
...
flex version 2.6.0 usage statistics:
  ...
  75 state/nextstate pairs created
  27/48 unique/duplicate transitions
  18/1000 base-def entries created
  31/2000 (peak 27) nxt-chk entries created
  6/2500 (peak 24) template nxt-chk entries created
  3 empty table entries
  5 protos created
  3 templates created, 6 uses
  8/256 equivalence classes created
  2/256 meta-equivalence classes created
  0 (0 saved) hash collisions, 15 DFAs equal
  0 sets of reallocations needed
  362 total table entries needed
